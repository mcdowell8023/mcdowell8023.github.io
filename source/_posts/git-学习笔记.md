...
- [2. 初始化](#2-初始化)
  - [2.1. 基本配置](#21-基本配置)
    - [2.1.1. 配置帐号信息](#211-配置帐号信息)
    - [2.1.2. 配置别名](#212-配置别名)
    - [2.1.3. 查看配置](#213-查看配置)
    - [2.1.4. 参数说明](#214-参数说明)
  - [2.2. 生成 shh 密钥](#22-生成-shh-密钥)
  - [2.3. 获取 Git 仓库](#23-获取-git-仓库)
    - [2.3.1. 在现有目录中初始化仓库](#231-在现有目录中初始化仓库)
    - [2.3.2. 克隆现有的仓库](#232-克隆现有的仓库)
    - [2.3.3. 本地已有构建的项目](#233-本地已有构建的项目)
  - [2.4. 不进行版本控制](#24-不进行版本控制)
    - [2.4.1. 添加不进行版本控制的文件目录](#241-添加不进行版本控制的文件目录)
    - [2.4.2. 提交 commit 后，想再忽略一些已经提交的文件](#242-提交-commit-后想再忽略一些已经提交的文件)
- [3. 常见操作](#3-常见操作)
  - [3.1. 查看信息](#31-查看信息)
    - [3.1.1. 查看帮助 git help](#311-查看帮助-git-help)
    - [3.1.2. 查看状态 git status](#312-查看状态-git-status)
    - [3.1.3. 查看变化 git diff](#313-查看变化-git-diff)
    - [3.1.4. 查看日志 git log](#314-查看日志-git-log)
    - [3.1.5. 查看某个文件的版本历史 git show](#315-查看某个文件的版本历史-git-show)
    - [3.1.6. 图形化查看提交内容 gitk](#316-图形化查看提交内容-gitk)
  - [3.2. 更新](#32-更新)
  - [3.3. 文件重命名](#33-文件重命名)
  - [3.4. 文件删除](#34-文件删除)
  - [3.5. 提交](#35-提交)
  - [3.6. 撤销&回滚](#36-撤销回滚)
    - [3.6.1. 简单总结](#361-简单总结)
    - [3.6.2. 撤销](#362-撤销)
      - [3.6.2.1. 修改文件 尚未提交](#3621-修改文件-尚未提交)
      - [3.6.2.2. 修改文件 已经提交（git commit）到 本地仓库](#3622-修改文件-已经提交git-commit到-本地仓库)
    - [3.6.3. 回滚](#363-回滚)
      - [3.6.3.1. 还原 远端服务器 提交的代码](#3631-还原-远端服务器-提交的代码)
      - [3.6.3.2. 删除最后一次远程提交](#3632-删除最后一次远程提交)
      - [3.6.3.3. 回滚某次提交](#3633-回滚某次提交)
      - [3.6.3.4. 删除某次提交](#3634-删除某次提交)
  - [3.7. 操作标签](#37-操作标签)
    - [3.7.1. 创建标签](#371-创建标签)
    - [3.7.2. 查看标签](#372-查看标签)
    - [3.7.3. 删除标签](#373-删除标签)
  - [3.8. 操作分支](#38-操作分支)
    - [3.8.1. 查看分支](#381-查看分支)
    - [3.8.2. 新建分支](#382-新建分支)
    - [3.8.3. 提交到远程分支](#383-提交到远程分支)
    - [3.8.4. 删除分支](#384-删除分支)
    - [3.8.5. 合并分支](#385-合并分支)
  - [3.9. 暂存](#39-暂存)
  - [3.10. 分离头【detached HEAD】](#310-分离头detached-head)
  - [3.11. 操作子仓库](#311-操作子仓库)
- [4. 常用命令详解](#4-常用命令详解)
  - [4.1. git pull 详解](#41-git-pull-详解)
  - [4.2. git fetch 详解](#42-git-fetch-详解)
  - [4.3. git add 详解](#43-git-add-详解)
  - [4.4. git commit 详解](#44-git-commit-详解)
  - [4.5. git remote 详解](#45-git-remote-详解)
  - [4.6. git push 详解](#46-git-push-详解)
    - [4.6.1. 语法](#461-语法)
    - [4.6.2. 示例](#462-示例)
      - [4.6.2.1. 完整示例](#4621-完整示例)
      - [4.6.2.2. 本地分支名 缺省](#4622-本地分支名-缺省)
      - [4.6.2.3. 本地分支、远程分支都 缺省](#4623-本地分支远程分支都-缺省)
      - [4.6.2.4. 远程主机名、本地分支、远程分支都 缺省](#4624-远程主机名本地分支远程分支都-缺省)
      - [4.6.2.5. simple 方式 和 matching 方式](#4625-simple-方式-和-matching-方式)
  - [4.7. git branch 详解](#47-git-branch-详解)
    - [4.7.1. 语法](#471-语法)
    - [4.7.2. 示例](#472-示例)
  - [4.8. git checkout 详解](#48-git-checkout-详解)
    - [4.8.1. 例子](#481-例子)
  - [4.9. git reset 详解](#49-git-reset-详解)
  - [4.10. git cherry-pick 详解](#410-git-cherry-pick-详解)
  - [4.11. git submodule 详解](#411-git-submodule-详解)
- [5. git 原理](#5-git-原理)
  - [5.1. git 工作解析图](#51-git-工作解析图)
  - [5.2. git 文件目录](#52-git-文件目录)
    - [5.2.1. commit 与 tree 和 blob 的关系](#521-commit-与-tree-和-blob-的关系)
  - [5.3. git 注意事项](#53-git-注意事项)
  - [5.4. 常见缩写](#54-常见缩写)
